...
class _$CommentsRecord extends CommentsRecord {
  ...
  _$CommentsRecord._({this.author, this.content, this.ffRef}) : super._();
  ...
  int get hashCode {
    return $jf(
        $jc($jc($jc(0, author.hashCode), content.hashCode), ffRef.hashCode));
  }
...
class CommentsRecordBuilder
  ...
  _$CommentsRecord _build() {
    final _$result = _$v ??
        new _$CommentsRecord._(author: author, content: content, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
